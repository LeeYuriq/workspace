...
public class ArraysSearchExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("search 7 : " + index);	// 10보다 앞자리에서 7을 찾지 못해서 찾기 시작한 자리를 -로 나타냄
		...
		// 일반적으로 정렬되지 않은 배열에서 데이털르 검색할 때 사용
