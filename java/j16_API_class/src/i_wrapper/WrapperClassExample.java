...
public class WrapperClassExample {
	...
	public static void main(String[] args) {
		...
		// 자동 Boxing
		// int type은 명시해줄 필요없이 값만 변경해서 사용가능
		obj1 = 100;
		
		// unBoxing : 포장객체에서 데이터를 가져올 때 타입변환가능
		// int type은 따로 명시해줄 필요없이 가져올 수 있음
		...
		// Number를 상속 받고 있지 않은 객체는 매개변수에 대입 불가
		// test(Boolean.valueOf("true"));
		test(3.141592); // 자동 Boxing
		test(null);	// Number도 객체 타입이니까 null 대입 가능 
		test(1111111111L);
