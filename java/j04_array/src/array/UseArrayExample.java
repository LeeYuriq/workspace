...
/**
 * 자료구조(Data 	Structure)
 * 데이터를 효율적으로 저장하고 조적하기 위한 방법을 정의한 것</br>
 ...
 * 동일한 자료형의 데이터를 연속된 공간에 순차적으로 나열한 것</br>
...
public class UseArrayExample {
	...
	public static void main(String[] args) {
		 ...
		 * 1. 배열에 저장할 값이 있을 시
		 */
		//나열되어 있는 값으로 크기가 결정되므로 크기를 지정항 필요가 없음.
		int[] array = new int[] {10, 20, 30, 40, 50};
		
		//2. 선언과 동시에 값을 지정할 떄는 new 연산자를 생략 가능함
		int array2[]= {80, 40, 70, 60, };
		//3. 선언 이후에 배열 항목을 초기화할때는 new 연산자를 생략할 수 없음
		int[] array3;
		//array = {100, 200, 300};
