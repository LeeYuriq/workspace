...
public class TestArray {
	...
	public static void main(String[] args) {
		/*
		 * 주어진 정수 배열 numbers의 반복문을 사용하여 모든 요소(항목)를 
		 * 출력하는 소스코드를 작성하시오.
		 */
		...
		/*
		 * 주어진 정수 배열 numbers에서 홀수의 개수가 몇 개인지 
		 * 출력하는 소스코드를 작성하시오.
		 */
		...
		//for문 반복 잡업 수행 후 홀수의 개수가 저장된count 변수를 출력
		System.out.println("홀수의 개수는 : " + count);
		
		
		
		/*
		 * 반복문을 활용하여 주어진 2차원 배열 matrix의 모든 요소(항목)의 
		 * 값을 더하여 합계를 출력하는소스코드를 작성하시오
		 */
		int[][] matrix = {
			//   0  1  2	
				{1, 2, 3},  // matrix[0]
