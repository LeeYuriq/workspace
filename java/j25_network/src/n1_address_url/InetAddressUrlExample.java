...
public class InetAddressUrlExample {
	...
	public static void main(String[] args) {
		...
		try {
			// 예외 처리 블럭 지정 : alt + s, w
			// Java에서 ip주소를 표현하기 위해서 제공되는 클래스
...
// https://post.naver.com/viewer/postView.naver?volumeNo=37970495&memberNo=30120665
			URI uri = new URI("https://post.naver.com/viewer/postView.naver?volumeNo=37970495&memberNo=30120665");
			URL url =uri.toURL();
...
}// end InetAddressUrlExample class
