...
public class CustomerExample {
	...
	public static void main(String[] args) {
		...
		customerList[4] = new VIPCustomer(777777,"김기환", 10111);
		...
		for(Customer c : customerList) {
			...
			for(Customer c1 : customerList) {
				if(c1 != null) {
					int cost = c1.calcPrice(price);
					System.out.println(c1.customerName+"님이 "+cost+"원을 지불하였습니다");
					System.out.println(c1); // 지불완료 후 고객 정보 출력 
				}
			}
		}
