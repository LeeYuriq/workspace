...
public class AndroidSmartPhone extends DMBPhone {
	...
	*/
	...
	void turnOnInternet() {
		System.out.println("인터넷 " +this.url+"을 켭니다");
	}
	...
	// 부모(상위) class가 정의한 method를 자식(하위) class에 맞게 다시 정의하는 것
	// @Override
	// 재정의된 method는 상위클래스의 접근 제한자보다 좁은 범위의 접근제한자를 가질 수 없음.
	// private void bell(){  // 부모가 가진 접근제한자보다 넓은 범위를 가질 수 있음.
	public void bell() {
